...
class RealTimeServiceCall {
  ...
  void initSocket(String userId) {
    ...
    _socket.on("incomingCall", (data) {
      if (onIncomingCall != null) onIncomingCall!(data["caller"]);
    });

    _socket.on("callAccepted", (_) => _createPeerConnection());
    ...
    _socket.on("offer", (data) async {
      ...
      _socket.emit("answer", {"to": data["from"], "sdp": answer!.sdp});
    });
